...
STATIC_DIR = os.path.abspath('D:/MOVIE PROJECT/movie-recommendation-system-main/movie-recommendation-system-main/templates/static')
...
#  Creates a Flask app instance with a specified static folder.
